...
import {setLoginToken} from "../../../actions/adminLoginActions"
import {connect} from 'react-redux'
import {fundcastFetchOptionsOverride} from "../../../shared/fetchOverrideOptions"
import {adminLogin} from '../../../shared/queries'
        ...
        if (this.isValid()) {
            ...
            this.props.graphql
                ...
                .request.then(({data}) => {
                    ...
                    if (data.adminLogin.token === null || !data.adminLogin.ok) {
                        this.setState({errors: {form: data.adminLogin.error}, isLoading: false})
                    }
                    else {
                        this.props.setLoginToken(data.adminLogin.token)
            ...
            <form onSubmit={this.onSubmit}>
                ...
                <div className="form-group row">
                    <div className="col-sm-9 offset-3">
                        <button disabled={isLoading || invalid} className="btn btn-primary btn-sm form-control"
                                type="submit">Login
                        </button>
                    </div>
                </div>
